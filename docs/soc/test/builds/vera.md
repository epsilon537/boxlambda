...
![Frame Generated by vera_integrated Vmodel.](../../../assets/vera-integrated-frame.png)

*Frame generated by vera_integrated Verilator model.*

The terminal window should look like this:

![vera_integrated terminal window.](../../../assets/vera-integrated-terminal-window.png)

*Vera_integrated Verilator model terminal window output.*

## Vera_integrated on the Arty A7

Hook up the VGA PMOD as described [here](../../../installation/pmods.md#vga-pmod).
...
![Arty A7 Setup for vera_integrated Test SoC.](../../../assets/vera-fpga-test-setup.jpg)
