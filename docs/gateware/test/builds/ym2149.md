...
```
![Audio DAC Test Frequency Magnitude Plot.](../../../assets/audio-dac-test-freq-mag-plot.jpg)

*Audio DAC Test Frequency Magnitude Plot.*

![Audio DAC Test Time Domain Plot.](../../../assets/audio-dac-test-time-domain-plot.jpg)
...
Hook up the Audio PMOD as described [here](../../../installation/pmods.md#audio-pmod).
...
![Dual YM2149 6-channel Pitch Test Frequency Spectrum Plot.](../../../assets/ym2149-6ch-pitch-test.jpg)
...
Locate the YM file `ANCOOL1.YM` in the directory `sub/StSound/YmSampleFiles/`. Copy it to a FAT-formatted SD card and insert the SD card into the card reader.
