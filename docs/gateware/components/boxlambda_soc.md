...
The BoxLambda SoC module is defined as a gateware component. The [Gateware Build Structure](../../build_sys/gateware/build_struct.md) section describes the three-layer gateware build structure. The diagram below shows how the BoxLambda SoC component fits into that build structure.
