...
- Software:
  ...
  - Applications:
      - BoxLambda OS:
        ...
        - Forth:
          - [The Mecrisp Forth Core](software/applications/boxlambda-os/forth/core.md)
          - [The Forth-C FFI](software/applications/boxlambda-os/forth/c-ffi.md)
          - [Stack Notation](software/applications/boxlambda-os/forth/stack-notation.md)
          - [Forth Word Glossary](software/applications/boxlambda-os/forth/words.md)
          - [Interrupt Handling](software/applications/boxlambda-os/forth/irqs.md)
          - [Exception Handling](software/applications/boxlambda-os/forth/exception-handling.md)
