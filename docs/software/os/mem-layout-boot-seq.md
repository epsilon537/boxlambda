...
1. `crt0.c` sets up a basic C environment as described [here](../c-components/picolibc.md#software-startup-sequence), unpacking and initializing the different sections into IMEM and EMEM as shown in the memory layout diagram above.
