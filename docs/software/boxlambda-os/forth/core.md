...
Understanding the purpose of the following assembler variables, defined in [forth-core.s](../../../../sw/components/forth/forth-core.s), is essential to be able to understand the Forth Core:
