...
This section discusses general requirements. The OS chapter has a [section](os_requirements.md) discussing requirements applying specifically to the OS architecture.
