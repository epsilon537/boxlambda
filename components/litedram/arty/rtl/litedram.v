...
reg  [5:0] phaseinjector0_command_storage = 6'd0;
...
reg  [5:0] phaseinjector1_command_storage = 6'd0;
...
reg  [5:0] phaseinjector2_command_storage = 6'd0;
...
reg  [5:0] phaseinjector3_command_storage = 6'd0;
...
wire timer_wait;
wire timer_done0;
wire [9:0] timer_count0;
wire timer_done1;
reg  [9:0] timer_count1 = 10'd781;
...
wire [26:0] zqcs_timer_count0;
wire zqcs_timer_done1;
reg  [26:0] zqcs_timer_count1 = 27'd99999999;
...
(* dont_touch = "true" *) reg  bankmachine0_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine0_twtpcon_count = 3'd0;
wire bankmachine0_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine0_trccon_ready = 1'd0;
reg  [2:0] bankmachine0_trccon_count = 3'd0;
wire bankmachine0_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine0_trascon_ready = 1'd0;
reg  [2:0] bankmachine0_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine1_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine1_twtpcon_count = 3'd0;
wire bankmachine1_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine1_trccon_ready = 1'd0;
reg  [2:0] bankmachine1_trccon_count = 3'd0;
wire bankmachine1_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine1_trascon_ready = 1'd0;
reg  [2:0] bankmachine1_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine2_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine2_twtpcon_count = 3'd0;
wire bankmachine2_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine2_trccon_ready = 1'd0;
reg  [2:0] bankmachine2_trccon_count = 3'd0;
wire bankmachine2_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine2_trascon_ready = 1'd0;
reg  [2:0] bankmachine2_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine3_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine3_twtpcon_count = 3'd0;
wire bankmachine3_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine3_trccon_ready = 1'd0;
reg  [2:0] bankmachine3_trccon_count = 3'd0;
wire bankmachine3_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine3_trascon_ready = 1'd0;
reg  [2:0] bankmachine3_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine4_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine4_twtpcon_count = 3'd0;
wire bankmachine4_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine4_trccon_ready = 1'd0;
reg  [2:0] bankmachine4_trccon_count = 3'd0;
wire bankmachine4_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine4_trascon_ready = 1'd0;
reg  [2:0] bankmachine4_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine5_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine5_twtpcon_count = 3'd0;
wire bankmachine5_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine5_trccon_ready = 1'd0;
reg  [2:0] bankmachine5_trccon_count = 3'd0;
wire bankmachine5_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine5_trascon_ready = 1'd0;
reg  [2:0] bankmachine5_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine6_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine6_twtpcon_count = 3'd0;
wire bankmachine6_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine6_trccon_ready = 1'd0;
reg  [2:0] bankmachine6_trccon_count = 3'd0;
wire bankmachine6_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine6_trascon_ready = 1'd0;
reg  [2:0] bankmachine6_trascon_count = 3'd0;
...
(* dont_touch = "true" *) reg  bankmachine7_twtpcon_ready = 1'd0;
reg  [2:0] bankmachine7_twtpcon_count = 3'd0;
wire bankmachine7_trccon_valid;
(* dont_touch = "true" *) reg  bankmachine7_trccon_ready = 1'd0;
reg  [2:0] bankmachine7_trccon_count = 3'd0;
wire bankmachine7_trascon_valid;
(* dont_touch = "true" *) reg  bankmachine7_trascon_ready = 1'd0;
reg  [2:0] bankmachine7_trascon_count = 3'd0;
wire ras_allowed;
wire cas_allowed;
wire [1:0] rdcmdphase;
wire [1:0] wrcmdphase;
...
reg  steerer7 = 1'd1;
wire trrdcon_valid;
(* dont_touch = "true" *) reg  trrdcon_ready = 1'd0;
reg  trrdcon_count = 1'd0;
wire tfawcon_valid;
(* dont_touch = "true" *) reg  tfawcon_ready = 1'd1;
wire [2:0] tfawcon_count;
reg  [4:0] tfawcon_window = 5'd0;
wire tccdcon_valid;
(* dont_touch = "true" *) reg  tccdcon_ready = 1'd0;
reg  tccdcon_count = 1'd0;
wire twtrcon_valid;
(* dont_touch = "true" *) reg  twtrcon_ready = 1'd0;
...
wire interface0_wb_port_we;
reg  interface0_wb_port_err = 1'd0;
...
wire interface1_wb_port_we;
reg  interface1_wb_port_err = 1'd0;
reg  litedramwishbone2native1_aborted = 1'd0;
reg  litedramwishbone2native1_is_ongoing = 1'd0;
...
reg  litedramwishbone2native0_aborted_litedramwishbone2native0_next_value = 1'd0;
reg  litedramwishbone2native0_aborted_litedramwishbone2native0_next_value_ce = 1'd0;
reg  [1:0] litedramcore_litedramwishbone2native1_state = 2'd0;
reg  [1:0] litedramcore_litedramwishbone2native1_next_state = 2'd0;
reg  litedramwishbone2native1_aborted_litedramwishbone2native1_next_value = 1'd0;
reg  litedramwishbone2native1_aborted_litedramwishbone2native1_next_value_ce = 1'd0;
...
assign interface0_wb_port_adr = user_port_wishbone_0_adr;
assign interface0_wb_port_dat_w = user_port_wishbone_0_dat_w;
assign user_port_wishbone_0_dat_r = interface0_wb_port_dat_r;
assign interface0_wb_port_sel = user_port_wishbone_0_sel;
assign interface0_wb_port_cyc = (user_port_wishbone_0_cyc & user_enable0);
assign interface0_wb_port_stb = (user_port_wishbone_0_stb & user_enable0);
assign user_port_wishbone_0_ack = (interface0_wb_port_ack & user_enable0);
assign interface0_wb_port_we = user_port_wishbone_0_we;
assign user_port_wishbone_0_err = interface0_wb_port_err;
assign interface1_wb_port_adr = user_port_wishbone_1_adr;
assign interface1_wb_port_dat_w = user_port_wishbone_1_dat_w;
assign user_port_wishbone_1_dat_r = interface1_wb_port_dat_r;
assign interface1_wb_port_sel = user_port_wishbone_1_sel;
assign interface1_wb_port_cyc = (user_port_wishbone_1_cyc & user_enable1);
assign interface1_wb_port_stb = (user_port_wishbone_1_stb & user_enable1);
assign user_port_wishbone_1_ack = (interface1_wb_port_ack & user_enable1);
assign interface1_wb_port_we = user_port_wishbone_1_we;
assign user_port_wishbone_1_err = interface1_wb_port_err;
...
assign csr_dfi_p0_cke = cke;
assign csr_dfi_p1_cke = cke;
assign csr_dfi_p2_cke = cke;
assign csr_dfi_p3_cke = cke;
assign csr_dfi_p0_odt = odt;
assign csr_dfi_p1_odt = odt;
assign csr_dfi_p2_odt = odt;
assign csr_dfi_p3_odt = odt;
...
always @(*) begin
	...
	case (litedramcore_litedramwishbone2native0_state)
		1'd1: begin
			if (litedramnativeport0_wdata_ready1) begin
...
always @(*) begin
	litedramwishbone2native0_aborted_litedramwishbone2native0_next_value_ce <= 1'd0;
	case (litedramcore_litedramwishbone2native0_state)
		1'd1: begin
			litedramwishbone2native0_aborted_litedramwishbone2native0_next_value_ce <= 1'd1;
		end
		2'd2: begin
			litedramwishbone2native0_aborted_litedramwishbone2native0_next_value_ce <= 1'd1;
		end
...
always @(*) begin
	...
	case (litedramcore_litedramwishbone2native0_state)
		1'd1: begin
			litedramwishbone2native0_is_ongoing <= 1'd1;
		end
		2'd2: begin
		end
		default: begin
...
always @(*) begin
	...
	case (litedramcore_litedramwishbone2native1_state)
		1'd1: begin
			if (litedramnativeport1_wdata_ready1) begin
...
always @(*) begin
	litedramwishbone2native1_aborted_litedramwishbone2native1_next_value <= 1'd0;
	case (litedramcore_litedramwishbone2native1_state)
		1'd1: begin
			litedramwishbone2native1_aborted_litedramwishbone2native1_next_value <= ((~interface1_wb_port_cyc) | litedramwishbone2native1_aborted);
		end
		2'd2: begin
			litedramwishbone2native1_aborted_litedramwishbone2native1_next_value <= ((~interface1_wb_port_cyc) | litedramwishbone2native1_aborted);
		end
...
always @(*) begin
	litedramwishbone2native1_aborted_litedramwishbone2native1_next_value_ce <= 1'd0;
	case (litedramcore_litedramwishbone2native1_state)
		1'd1: begin
			litedramwishbone2native1_aborted_litedramwishbone2native1_next_value_ce <= 1'd1;
		end
		2'd2: begin
			litedramwishbone2native1_aborted_litedramwishbone2native1_next_value_ce <= 1'd1;
		end
...
assign csrbank2_dfii_pi0_command0_w = phaseinjector0_command_storage[5:0];
...
assign csrbank2_dfii_pi1_command0_w = phaseinjector1_command_storage[5:0];
...
assign csrbank2_dfii_pi2_command0_w = phaseinjector2_command_storage[5:0];
...
assign csrbank2_dfii_pi3_command0_w = phaseinjector3_command_storage[5:0];
...
always @(posedge sys_clk) begin
	...
	if ((sequencer_counter == 2'd3)) begin
		cmd_payload_a <= 11'd1024;
		cmd_payload_ba <= 1'd0;
	...
	if ((sequencer_counter == 6'd35)) begin
		cmd_payload_a <= 1'd0;
		cmd_payload_ba <= 1'd0;
		cmd_payload_cas <= 1'd0;
		cmd_payload_ras <= 1'd0;
	...
	if ((zqcs_timer_wait & (~zqcs_timer_done0))) begin
		...
		zqcs_timer_count1 <= 27'd99999999;
	end
	...
	if ((zqcs_executer_counter == 2'd3)) begin
		cmd_payload_a <= 1'd0;
		cmd_payload_ba <= 1'd0;
		cmd_payload_cas <= 1'd0;
		cmd_payload_ras <= 1'd0;
	...
	if ((zqcs_executer_counter == 5'd19)) begin
		cmd_payload_a <= 1'd0;
		cmd_payload_ba <= 1'd0;
		cmd_payload_cas <= 1'd0;
		cmd_payload_ras <= 1'd0;
	...
	if (bankmachine0_trccon_valid) begin
		bankmachine0_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine0_trascon_valid) begin
		bankmachine0_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine1_trccon_valid) begin
		bankmachine1_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine1_trascon_valid) begin
		bankmachine1_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine2_trccon_valid) begin
		bankmachine2_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine2_trascon_valid) begin
		bankmachine2_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine3_trccon_valid) begin
		bankmachine3_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine3_trascon_valid) begin
		bankmachine3_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine4_trccon_valid) begin
		bankmachine4_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine4_trascon_valid) begin
		bankmachine4_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine5_trccon_valid) begin
		bankmachine5_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine5_trascon_valid) begin
		bankmachine5_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine6_trccon_valid) begin
		bankmachine6_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine6_trascon_valid) begin
		bankmachine6_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	if (bankmachine7_trccon_valid) begin
		bankmachine7_trccon_count <= 3'd5;
		if (1'd0) begin
	...
	if (bankmachine7_trascon_valid) begin
		bankmachine7_trascon_count <= 3'd4;
		if (1'd0) begin
	...
	litedramcore_new_master_wdata_ready0 <= ((((((((1'd0 | ((litedramcore_roundrobin0_grant == 1'd0) & interface_bank0_wdata_ready)) | ((litedramcore_roundrobin1_grant == 1'd0) & interface_bank1_wdata_ready)) | ((litedramcore_roundrobin2_grant == 1'd0) & interface_bank2_wdata_ready)) | ((litedramcore_roundrobin3_grant == 1'd0) & interface_bank3_wdata_ready)) | ((litedramcore_roundrobin4_grant == 1'd0) & interface_bank4_wdata_ready)) | ((litedramcore_roundrobin5_grant == 1'd0) & interface_bank5_wdata_ready)) | ((litedramcore_roundrobin6_grant == 1'd0) & interface_bank6_wdata_ready)) | ((litedramcore_roundrobin7_grant == 1'd0) & interface_bank7_wdata_ready));
	litedramcore_new_master_wdata_ready1 <= litedramcore_new_master_wdata_ready0;
	litedramcore_new_master_wdata_ready2 <= ((((((((1'd0 | ((litedramcore_roundrobin0_grant == 1'd1) & interface_bank0_wdata_ready)) | ((litedramcore_roundrobin1_grant == 1'd1) & interface_bank1_wdata_ready)) | ((litedramcore_roundrobin2_grant == 1'd1) & interface_bank2_wdata_ready)) | ((litedramcore_roundrobin3_grant == 1'd1) & interface_bank3_wdata_ready)) | ((litedramcore_roundrobin4_grant == 1'd1) & interface_bank4_wdata_ready)) | ((litedramcore_roundrobin5_grant == 1'd1) & interface_bank5_wdata_ready)) | ((litedramcore_roundrobin6_grant == 1'd1) & interface_bank6_wdata_ready)) | ((litedramcore_roundrobin7_grant == 1'd1) & interface_bank7_wdata_ready));
	litedramcore_new_master_wdata_ready3 <= litedramcore_new_master_wdata_ready2;
	litedramcore_new_master_rdata_valid0 <= ((((((((1'd0 | ((litedramcore_roundrobin0_grant == 1'd0) & interface_bank0_rdata_valid)) | ((litedramcore_roundrobin1_grant == 1'd0) & interface_bank1_rdata_valid)) | ((litedramcore_roundrobin2_grant == 1'd0) & interface_bank2_rdata_valid)) | ((litedramcore_roundrobin3_grant == 1'd0) & interface_bank3_rdata_valid)) | ((litedramcore_roundrobin4_grant == 1'd0) & interface_bank4_rdata_valid)) | ((litedramcore_roundrobin5_grant == 1'd0) & interface_bank5_rdata_valid)) | ((litedramcore_roundrobin6_grant == 1'd0) & interface_bank6_rdata_valid)) | ((litedramcore_roundrobin7_grant == 1'd0) & interface_bank7_rdata_valid));
	...
	litedramcore_new_master_rdata_valid9 <= ((((((((1'd0 | ((litedramcore_roundrobin0_grant == 1'd1) & interface_bank0_rdata_valid)) | ((litedramcore_roundrobin1_grant == 1'd1) & interface_bank1_rdata_valid)) | ((litedramcore_roundrobin2_grant == 1'd1) & interface_bank2_rdata_valid)) | ((litedramcore_roundrobin3_grant == 1'd1) & interface_bank3_rdata_valid)) | ((litedramcore_roundrobin4_grant == 1'd1) & interface_bank4_rdata_valid)) | ((litedramcore_roundrobin5_grant == 1'd1) & interface_bank5_rdata_valid)) | ((litedramcore_roundrobin6_grant == 1'd1) & interface_bank6_rdata_valid)) | ((litedramcore_roundrobin7_grant == 1'd1) & interface_bank7_rdata_valid));
	...
	if (litedramwishbone2native0_aborted_litedramwishbone2native0_next_value_ce) begin
		litedramwishbone2native0_aborted <= litedramwishbone2native0_aborted_litedramwishbone2native0_next_value;
	end
	litedramcore_litedramwishbone2native1_state <= litedramcore_litedramwishbone2native1_next_state;
	if (litedramwishbone2native1_aborted_litedramwishbone2native1_next_value_ce) begin
		litedramwishbone2native1_aborted <= litedramwishbone2native1_aborted_litedramwishbone2native1_next_value;
	end
	...
	if (csrbank2_dfii_pi0_command0_re) begin
		phaseinjector0_command_storage[5:0] <= csrbank2_dfii_pi0_command0_r;
	end
	...
	if (csrbank2_dfii_pi1_command0_re) begin
		phaseinjector1_command_storage[5:0] <= csrbank2_dfii_pi1_command0_r;
	end
	...
	if (csrbank2_dfii_pi2_command0_re) begin
		phaseinjector2_command_storage[5:0] <= csrbank2_dfii_pi2_command0_r;
	end
	...
	if (csrbank2_dfii_pi3_command0_re) begin
		phaseinjector3_command_storage[5:0] <= csrbank2_dfii_pi3_command0_r;
	end
	...
	if (sys_rst) begin
		...
		storage <= 4'd1;
		re <= 1'd0;
		phaseinjector0_command_storage <= 6'd0;
		...
		phaseinjector1_command_storage <= 6'd0;
		...
		phaseinjector2_command_storage <= 6'd0;
		...
		phaseinjector3_command_storage <= 6'd0;
		...
		bankmachine0_trccon_ready <= 1'd0;
		bankmachine0_trccon_count <= 3'd0;
		bankmachine0_trascon_ready <= 1'd0;
		bankmachine0_trascon_count <= 3'd0;
		...
		bankmachine1_trccon_ready <= 1'd0;
		bankmachine1_trccon_count <= 3'd0;
		bankmachine1_trascon_ready <= 1'd0;
		bankmachine1_trascon_count <= 3'd0;
		...
		bankmachine2_trccon_ready <= 1'd0;
		bankmachine2_trccon_count <= 3'd0;
		bankmachine2_trascon_ready <= 1'd0;
		bankmachine2_trascon_count <= 3'd0;
		...
		bankmachine3_trccon_ready <= 1'd0;
		bankmachine3_trccon_count <= 3'd0;
		bankmachine3_trascon_ready <= 1'd0;
		bankmachine3_trascon_count <= 3'd0;
		...
		bankmachine4_trccon_ready <= 1'd0;
		bankmachine4_trccon_count <= 3'd0;
		bankmachine4_trascon_ready <= 1'd0;
		bankmachine4_trascon_count <= 3'd0;
		...
		bankmachine5_trccon_ready <= 1'd0;
		bankmachine5_trccon_count <= 3'd0;
		bankmachine5_trascon_ready <= 1'd0;
		bankmachine5_trascon_count <= 3'd0;
		...
		bankmachine6_trccon_ready <= 1'd0;
		bankmachine6_trccon_count <= 3'd0;
		bankmachine6_trascon_ready <= 1'd0;
		bankmachine6_trascon_count <= 3'd0;
		...
		bankmachine7_trccon_ready <= 1'd0;
		bankmachine7_trccon_count <= 3'd0;
		bankmachine7_trascon_ready <= 1'd0;
		bankmachine7_trascon_count <= 3'd0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-11-28 16:40:33.
//------------------------------------------------------------------------------
