...
python $NEXTPNR_XILINX_PYTHON_DIR/bbaexport.py --device xc7a35tcsg324-1 --bba xc7a35tcsg324.bba
echo "bbaasm xca35t"
bbasm -l xc7a35tcsg324.bba xc7a35tcsg324.bin
#rm -f xc7a35tcsg324.bba

echo "bbaexporting xca100t"
python $NEXTPNR_XILINX_PYTHON_DIR/bbaexport.py --device xc7a100tcsg324-1 --bba xc7a100tcsg324.bba
echo "bbaasm xca100t"
