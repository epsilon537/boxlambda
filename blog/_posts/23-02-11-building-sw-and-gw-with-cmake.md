...
*Updated 1 May 2026: Corrected stale links.*
...
Building Gateware
-----------------
Assuming all [Prerequisites](https://boxlambda.readthedocs.io/en/feb_11_23/installation-and-test-builds/#prerequisites) are installed, navigate to the build tree of choice and type:
...
See the BoxLambda documentation [Bender section](https://boxlambda.readthedocs.io/en/feb_11_23/build-system/#bender) of for more info on how BoxLambda uses Bender.
...
![CMakeLists organization.](../assets/building-sw-and-gw-with-cmake/CMakeLists_Org.drawio.png)
...
![CMake and Bender Interaction.](../assets/building-sw-and-gw-with-cmake/CMake_Bender_Interaction.drawio.png)
...
Repository setup
================
   1. Install the [Prerequisites](https://boxlambda.readthedocs.io/en/feb_11_23/installation-and-test-builds/#prerequisites).
...
![ddr_test on Verilator](../assets/building-sw-and-gw-with-cmake/ddr_test_verilator.png)
...
![ddr_test on Arty - Putty Terminal](../assets/building-sw-and-gw-with-cmake/ddr_test_arty.png)
