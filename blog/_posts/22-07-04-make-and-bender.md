...
![Project View of the Build System](../assets/make-and-bender/Project_Build_Diagram.drawio.png){:class="img-responsive"}
...
![The Build System Files - arrows indicate information flow](../assets/make-and-bender/Build_System_Files.drawio.png){:class="img-responsive"}
...
![Component View of the Build System](../assets/make-and-bender/Component_Build_Diagram.drawio.png){:class="img-responsive"}
