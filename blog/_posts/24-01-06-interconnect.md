...
![BoxLambda with revised interconnect.](../assets/interconnect/Arch_Diagram_Interconnect_Focus.png)
...
![Shared Bus Example.](../assets/interconnect/SharedBusExample.png)
...
![Original BoxLambda Architecture Diagram.](../assets/interconnect/Original_Arch_Diagram.png)
...
![Crossbar Example.](../assets/interconnect/CrossBarExample.png)
...
![New BoxLambda Architecture Diagram.](../assets/interconnect/Arch_Diagram_Big.png)
...
=======================
![Harvard vs. Von Neumann Architecture.](../assets/interconnect/HarvardvsVonNeumann.png)
...
![Word Copy in Von Neumann Architecture.](../assets/interconnect/vonNeuMannWaveForm.png)
...
![Word Copy in Harvard Architecture.](../assets/interconnect/harvardWaveForm.png)
...
![DPRAM simultaneous access.](../assets/interconnect/dpram_simultaneous_access.png)
...
![Byte vs. Word Addressing.](../assets/interconnect/byte_vs_word_addressing.png)
...
![Word Addressing a byte with byte enables.](../assets/interconnect/addressing_a_byte_w_byte_enables.png)
...
![BoxLambda SoC Component Build Diagram.](../assets/interconnect/BoxLambda_SoC_Component_Build_Diagram.png)
