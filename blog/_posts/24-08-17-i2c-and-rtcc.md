...
Recap
-----
![BoxLambda Block Diagram.](../assets/i2c-and-rtcc/Arch_Diagram_I2C_Focus.png)
...
![I2C transaction with 7-bit slave address](../assets/i2c-and-rtcc/I2C-Bits-Protocol.jpg)
...
![WBI2C Master Core](../assets/i2c-and-rtcc/wbi2c_master.png)
...
![I2C bus with pull-up resistors](../assets/i2c-and-rtcc/i2c_bus_w_pullups.png)
...
![SCL and SDA Pull-Up Pins on Arty A7 Schematic](../assets/i2c-and-rtcc/scl_sda_pup_schematic.png)
...
![RTCC PMOD Setup.](../assets/i2c-and-rtcc/rtcc_pmod.jpg)
...
![CMT200T E](../assets/i2c-and-rtcc/CMR200T_E.png)
