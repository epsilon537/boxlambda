...
*Updated 30 April 2026: Corrected broken image reference.*
...
[![The physical
setup.](../assets/sw-arch-1st-draft/physical_setup.png)](../assets/sw-arch-1st-draft/physical_setup.png)
...
![BoxLambda Block Diagram.](../assets/sw-arch-1st-draft/Arch-Diagram-dual-bus-DFX.png)
...
[![the programming language that writes itself.](../assets/sw-arch-1st-draft/forth_article.png)](https://ratfactor.com/forth/the_programming_language_that_writes_itself.html)
...
[![Explorations.](../assets/sw-arch-1st-draft/explorations.png)](../assets/sw-arch-1st-draft/explorations.png)
...
[![BoxLambda OS
Architecture.](../assets/sw-arch-1st-draft/BoxLambda_OS_Architecture.png)](../assets/sw-arch-1st-draft/BoxLambda_OS_Architecture.png)
...
[![
Flamingo.](../assets/sw-arch-1st-draft/flamingo.png)](../assets/sw-arch-1st-draft/flamingo.png)
...
[![The Canvas REPL.](../assets/sw-arch-1st-draft/canvas_repl.png)](../assets/sw-arch-1st-draft/canvas_repl.png)
