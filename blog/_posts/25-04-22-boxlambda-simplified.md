...
Recap
-----
[![BoxLambda Block Diagram.](../assets/boxlambda-simplified/Arch_Diagram_DFX_w_crossbar.png)](../assets/boxlambda-simplified/Arch_Diagram_DFX_w_crossbar.png)
...
[![CPU read word cycle count to a wishbone slave directly connected, through a mux, and through a crossbar.](../assets/boxlambda-simplified/read_word_direct_vs_mux_vs_crossbar.png)](../assets/boxlambda-simplified/read_word_direct_vs_mux_vs_crossbar.png)
...
[![BoxLambda SoC with Dual Bus Block Diagram.](../assets/boxlambda-simplified/Arch_Diagram_dual_bus_DFX.png)](../assets/boxlambda-simplified/Arch_Diagram_dual_bus_DFX.png)
...
[![The Data Bus and the Instruction Bus.](../assets/boxlambda-simplified/data_bus_and_instruction_bus.png)](../assets/boxlambda-simplified/data_bus_and_instruction_bus.png)
...
[![Arbiter without arbitration overhead on the default port.](../assets/boxlambda-simplified/arbiter_wo_overhead.png)](../assets/boxlambda-simplified/arbiter_wo_overhead.png)
...
![Dual Port VRAM](../assets/boxlambda-simplified/vera_dp_vram.png)
...
![Crosstool-ng menuconfig](../assets/boxlambda-simplified/ct-ng-menuconfig.png)
