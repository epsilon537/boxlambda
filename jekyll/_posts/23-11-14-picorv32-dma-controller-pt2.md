...
![PicoRV DMA Bus Utilization.](../assets/picorv32-dma-controller-pt2/PicoRV_Bus_Utilization.png)
...
Recap
-----
![PicoRV-based DMA Controller in the BoxLambda Architecture.](../assets/picorv32-dma-controller-pt2/Arch_Diagram_PICORV_DMA_focus.png)
...
-----------------------------------------------------
![Waveform of PicoRV 4x unrolled wordcopy.](../assets/picorv32-dma-controller-pt2/picorv_4x_unrolled_orig_waveform.png)
...
![Waveform of PicoRV 4x unrolled wordcopy.](../assets/picorv32-dma-controller-pt2/picorv_doubled_cpu_clock_waveform.png)
...
------------------------------------------------------------------
![PicoRV32 Native to Wishbone Master Adapter](../assets/picorv32-dma-controller-pt2/PicoRV_to_Wishbone.png)

*PicoRV32 Native to Wishbone Master Adapter.*

![PicoRV32 Native to Wishbone Master Adapter](../assets/picorv32-dma-controller-pt2/picorv_to_wb_before_fast_stb_ack.png)

*PicoRV32 Native to Wishbone Master Transaction before optimization.*

![PicoRV32 Native to Wishbone Master Adapter Optimized](../assets/picorv32-dma-controller-pt2/picorv_to_wb_after_fast_stb_ack.png)
...
![PicoRV32 4x unrolled Word Copy with Fast STB/ACK and double PicoRV clock frequency.](../assets/picorv32-dma-controller-pt2/picorv_dma_wb0_to_wb0_wordcopy_single_unrolled.png)
...
![PicoRV DMA Burst Mode Sequence.](../assets/picorv32-dma-controller-pt2/PicoRV_DMA_Burst_Reg_R_W.png)
...
![PicoRV instructions vs. Burst Transaction.](../assets/picorv32-dma-controller-pt2/picorv_racing_burst_transactions.png)
...
![PicoRV Burst FSM Block Diagram.](../assets/picorv32-dma-controller-pt2/PicoRV_Burst_FSM_Block_Diagram.png)

*Block Diagram of the PicoRV Burst FSM Module.*

![PicoRV Burst FSM.](../assets/picorv32-dma-controller-pt2/PicoRV_DMA_Burst_FSM.png)

*The PicoRV Burst FSM Module's FSM.*

![PicoRV Burst FSM.](../assets/picorv32-dma-controller-pt2/PicoRV_DMA_Block_Diagram_New.png)
...
![PicoRV32 Word Copy Using Burst Mode.](../assets/picorv32-dma-controller-pt2/picorv_dma_wb0_to_wb0_wordcopy_burst.png)
