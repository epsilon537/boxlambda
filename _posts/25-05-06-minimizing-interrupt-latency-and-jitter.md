...
*Updated 30 April 2026: Corrected broke image reference.*
...
Recap
-----
![BoxLambda Block Diagram.](../assets/minimizing-interrupt-latency-and-jitter/Arch-Diagram-dual-bus-DFX.png)
...
[![Waveform of a Timer Interrupt Firing.](../assets/minimizing-interrupt-latency-and-jitter/timer_irq_waveform_before_changes.png)](../assets/minimizing-interrupt-latency-and-jitter/timer_irq_waveform_before_changes.png)
...
[![Interrupt Overhead before changes.](../assets/minimizing-interrupt-latency-and-jitter/irq_overhead_before.png)](../assets/minimizing-interrupt-latency-and-jitter/irq_overhead_before.png)
...
![The Ibex Register File including a Interrupt Shadow Register Bank](../assets/minimizing-interrupt-latency-and-jitter/irq_shadow_registers.png)
...
[![Interrupt Overhead after changes.](../assets/minimizing-interrupt-latency-and-jitter/irq_overhead_after.png)](../assets/minimizing-interrupt-latency-and-jitter/irq_overhead_after.png)
...
![Absorbing Timer Interrupt Jitter with MTIMEBLK](../assets/minimizing-interrupt-latency-and-jitter/mtimeblk_mechanism.png)
...
![Celebrate.](../assets/minimizing-interrupt-latency-and-jitter/celebrate.png)
