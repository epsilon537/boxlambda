...
*Updated 1 May 2026: Corrected missing links.*
...
![SPI Flash On On BoxLambda](../assets/spi-flash/spiflash_on_boxlambda.png)
...
Recap
-----
![BoxLambda Block Diagram.](../assets/spi-flash/Arch_Diagram_Flash_Focus.png)
...
![Arty A7 PCB revisions and their flash devices](../assets/spi-flash/arty_flash_devices.jpg)
...
![SPI Flash Core Diagram](../assets/spi-flash/spiflash_core_diagram.png)
...
![SPI Timing Design](../assets/spi-flash/spi_rising_falling_edge.png)
...
![Word read SPI Flash Transaction](../assets/spi-flash/spiflash_word_read.png)
...
![SPI Flash MOSI Timing](../assets/spi-flash/spi_flash_mosi_timing.png)
...
![SPI Flash MISO Timing](../assets/spi-flash/spi_flash_miso_timing.png)
...
- [vectors.S](https://github.com/epsilon537/boxlambda/tree/spi_flash/sw/components/bootstrap/vectors.S): Assembly code containing the Boot Vector and early startup code (nothing more than setting the CPU registers to zero, really).
...
![The Software Boot Sequence](../assets/spi-flash/spiflash_boot_sequence.png)
...
===========================================================
![LiteDRAM Back-to-Back Write Issue](../assets/spi-flash/litedram_b2b_write_issue.png)
