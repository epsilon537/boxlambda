...
Recap
-----
![BoxLambda Block Diagram.](../assets/interrupts/Arch_Diagram_IRQ_Focus.png)
...
![Condition Based Interrupts](../assets/interrupts/condition_based_irq.png)
...
![Event-Based Interrupts](../assets/interrupts/event_based_irq.png)
...
![UART Level Sensitive Interrupts](../assets/interrupts/uart_level_sensitive_irq_orig.png)

*The UART Core before modification: Level Sensitivity from source to CPU.*

Here's the UART core after modification:

![UART Edge Triggered Interrupts](../assets/interrupts/uart_edge_triggered_irqs_new.png)
...
![Mini Edge ICs](../assets/interrupts/miniEdgeICs.png)
...
![BoxLambda Interrupts](../assets/interrupts/irq_diagram.png)
...
![GPIO Core Block Diagram](../assets/interrupts/gpio_core_diagram.jpg)
