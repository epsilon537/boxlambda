...
![Dual YM2149 PSG in the BoxLambda Architecture.](../assets/dual-ym2149-audio-core/Arch_Diagram_YM2149_focus.png)
...
![YM2149 Block Diagram.](../assets/dual-ym2149-audio-core/ym2149_block_diagram_from_datasheet.jpg)
...
==========================
![YM2149 PSG System Block Diagram.](../assets/dual-ym2149-audio-core/ym2149_psg_sys_block_diagram.png)
...
![1-bit delta-sigma modulation (blue) of a sine wave (red).](../assets/dual-ym2149-audio-core/Pulse-density_modulation_1_period.gif)
...
![Second Order Delta Sigma Modulator.](../assets/dual-ym2149-audio-core/2nd_order_delta_sigma_modulator.jpg)
...
4. Execute the Audio DAC Test Python script. Pass in the *-p* option to see the plots. You should see a frequency domain plot, a time domain plot, and the correlation match between the PCM and the DAC signals:
  ...
  ```
![Audio DAC Test Frequency Magnitude Plot.](../assets/dual-ym2149-audio-core/audio_dac_test_freq_mag_plot.jpg)

*Audio DAC Test Frequency Magnitude Plot.*

![Audio DAC Test Time Domain Plot.](../assets/dual-ym2149-audio-core/audio_dac_test_time_domain_plot.jpg)
...
![Dual YM2149 6-channel Pitch Test Frequency Spectrum Plot.](../assets/dual-ym2149-audio-core/ym2149_6ch_pitch_test.jpg)
