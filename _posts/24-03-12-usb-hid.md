...
![BoxLambda Block Diagram.](../assets/usb-hid/Arch_Diagram_USB_Focus.png)
...
--------------------------------
![NAND2Mario usb_hid_host core.](../assets/usb-hid/usb_hid_host_orig.png)
...
![USB Host Dual Socket PMOD.](../assets/usb-hid/usb_host_dual_socket_pmod.jpg)
...
![SetReport Keyboard LED bitmap.](../assets/usb-hid/keyboard_led_bitmap.jpg)

*SetReport Keyboard LED bitmap.*

The entire packet sequence looks like this:

![SetReport Sequence Diagram.](../assets/usb-hid/SetReportSeqDiagram.png)
...
![Keyboard LED Control in usb_hid_host.](../assets/usb-hid/keyboard_led_ctrl_in_usb_hid_host.png)
...
-------------------------------------------
![usb_hid_host with Wishbone frontend.](../assets/usb-hid/usb_hid_host_new.png)
...
![MCP CDC using Toggle-Pulse.](../assets/usb-hid/mcp_toggle_pulse.jpg)
...
====================
![Simulation Setup.](../assets/usb-hid/usb_hid_host_and_device.png)
...
![BoxLambda Clocks](../assets/usb-hid/clocks.png)
...
![Reset Controller](../assets/usb-hid/reset_ctrl.png)

*BoxLambda's Reset Controller.*

The reset_ctrl module code is located here:

[https://github.com/epsilon537/boxlambda/blob/usb_hid_host/gw/components/reset_ctrl/rtl/reset_ctrl.sv](https://github.com/epsilon537/boxlambda/blob/usb_hid_host/gw/components/reset_ctrl/rtl/reset_ctrl.sv)
...
[https://github.com/epsilon537/boxlambda/blob/usb_hid_host/sw/components/usb_hid/usb_hid_hal.h](https://github.com/epsilon537/boxlambda/blob/usb_hid_host/sw/components/usb_hid/usb_hid_hal.h)
...
[https://github.com/epsilon537/boxlambda/blob/usb_hid_host/sw/projects/usb_hid_sys_test/usb_hid_sys_test.c](https://github.com/epsilon537/boxlambda/blob/usb_hid_host/sw/projects/usb_hid_sys_test/usb_hid_sys_test.c)
...
Setup
=====
1. Install the [Software Prerequisites](https://boxlambda.readthedocs.io/en/mar_12_24/installation-and-test-builds/#prerequisites).
...
![USB PMOD Setup](../assets/usb-hid/usb_pmod_setup.jpg)
