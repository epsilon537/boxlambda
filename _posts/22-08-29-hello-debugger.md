...
*Updated 1 May 2026: Fixed broken links.*
...
Debug Support
-------------
![RISCV-dbg in the BoxLambda architecture](../assets/hello-debugger/riscv_dbg_in_arch_diagram.drawio.png){:class="img-responsive"}
...
![OpenOCD General Setup](../assets/hello-debugger/OpenOCD_Setup_General.drawio.png){:class="img-responsive"}
...
![BoxLambda OpenOCD Verilator Setup](../assets/hello-debugger/OpenOCD_Setup_Verilator.drawio.png){:class="img-responsive"}
...
![OpenOCD JTAG Debug Session on Verilator](../assets/hello-debugger/Verilator_Debug_Session.jpg){:class="img-responsive"}
...
![BoxLambda OpenOCD Arty A7 FTDI Setup](../assets/hello-debugger/OpenOCD_Setup_Arty_A7.drawio.png){:class="img-responsive"}
