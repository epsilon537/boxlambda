...
---------------------------------------
![Arty A7 with MicroSD PMOD in JD port.](../assets/sd-and-fs-bring-up/arty_w_microsd_pmod.jpeg)
...
The SDSPI Core
==============
![SDSPI in the BoxLambda Architecture.](../assets/sd-and-fs-bring-up/Arch_Diagram_SDSPI_focus.drawio.png)
...
![SDSPI Block Diagram.](../assets/sd-and-fs-bring-up/sdspi_block_diagram.drawio.png)
...
![FatFs Media Access Interface.](../assets/sd-and-fs-bring-up/FatFs_Media_Access_Interface.drawio.png)
