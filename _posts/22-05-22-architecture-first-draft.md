...
![Nexys Draft Architecture Block Diagram](../assets/architecture-first-draft/Nexys_Arch_Diagram_Draft_Post.jpg){:class="img-responsive"}
...
![Arty Draft Architecture Block Diagram](../assets/architecture-first-draft/Arty_Arch_Diagram_Draft_Post.jpg){:class="img-responsive"}
