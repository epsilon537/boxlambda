...
*Updated 30 April 2026: Corrected stale links.*
*Updated 2 April 2026: Corrected stale links.*

*Updated 22 June 2025: Included Prefetcher FSM diagram.*

*Updated 13 April 2025: I corrected the breakdown of the 6 clock cycle register access time in [this section](#the-single-instruction-prefetcher).*
...
Recap
-----
![BoxLambda Block Diagram.](../assets/latency-shakeup/Arch_Diagram_NoDFX.png)
...
[![Before making any system changes, Ibex IF and ID stage executing a word copy loop.](../assets/latency-shakeup/word_copy_loop_compressed_instr.png)](../assets/latency-shakeup/word_copy_loop_compressed_instr.png)
...
[![Ibex IF Prefetcher and ID stage executing a word copy loop. All 32-bit instructions](../assets/latency-shakeup/word_copy_loop_uncompressed_instr.png)](../assets/latency-shakeup/word_copy_loop_uncompressed_instr.png)
...
![Ibex direct access to internal memory, bypassing the Crossbar](../assets/latency-shakeup/crossbar_bypass.png)

*Ibex direct access to internal memory, bypassing the Crossbar*

The waveform now looks like this:

[![Ibex IF Prefetcher and ID stage executing a word copy loop. Direct CPU access to internal memory](../assets/latency-shakeup/word_copy_loop_crossbar_bypass.png)](../assets/latency-shakeup/word_copy_loop_crossbar_bypass.png)
...
![CPU access to I2C, passing through two crossbars](../assets/latency-shakeup/cpu_access_to_i2c.png)
...
![BoxLambda SoC with two transaction separators and 1->13 MUX](../assets/latency-shakeup/stallers_and_1_13_mux.png)

*BoxLambda SoC with two transaction separators and 1->13 MUX.*

![Transaction Separator Signals: wbm_\* signals are bus master facing, wbs_\* signals are bus slave facing](../assets/latency-shakeup/wb_staller_waveform.png)
...
![CPU with default FIFO-based Prefetcher reading an I2C register in a loop](../assets/latency-shakeup/register_read_loop_default_prefetcher.png)
...
![The Single Instruction Prefetch Buffer in the Ibex Core.](../assets/latency-shakeup/ibex_single_prefetch_buffer.png)
...
![The Single Instruction Prefetcher FSM.](../assets/latency-shakeup/single_prefetch_buffer_fsm.png)
...
![CPU with Single Instruction Prefetcher reading an I2C register in a loop](../assets/latency-shakeup/register_read_loop_single_prefetcher.png)
...
[![CPU with Single Instruction Prefetcher copying words in VRAM](../assets/latency-shakeup/word_copy_loop_vram.png)](../assets/latency-shakeup/word_copy_loop_vram.png)
...
![Vera VRAM Interface](../assets/latency-shakeup/vera_vram_if.png)
...
[Install the prerequisites](https://boxlambda.readthedocs.io/en/mar_18_25/prerequisites/).
...
[![Ibex Performance Test Waveform in GTKWave](../assets/latency-shakeup/ibex_perf_test_gtkwave_screenshot.png)](../assets/latency-shakeup/ibex_perf_test_gtkwave_screenshot.png)
