...
make setup
==========
![Building Picolibc.](../assets/libc-for-boxlambda/building_picolibc.drawio.png){:class="img-responsive"}
...
------------------------------
![Picolibc on BoxLambda.](../assets/libc-for-boxlambda/picolibc_on_boxlambda.drawio.png){:class="img-responsive"}
...
![Picolibc_test on Verilator](../assets/libc-for-boxlambda/picolibc_test_verilator.png){:class="img-responsive"}
...
![Picolibc_test on Arty - Putty Terminal](../assets/libc-for-boxlambda/picolibc_test_arty.png){:class="img-responsive"}
