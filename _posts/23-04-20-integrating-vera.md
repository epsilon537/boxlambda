...
![VERA in the BoxLambda Architecture.](../assets/integrating-vera/Arch_Diagram_VERA_focus.drawio.png)
...
![Time Slot Scheduled VRAM Access.](../assets/integrating-vera/vram_if_timeslot_scheduling.drawio.png)
...
![Double Buffering with Sprite Banks.](../assets/integrating-vera/sprite_banking_double_buffering.drawio.png)

*Double Buffering with Sprite Banks Example.*

![Sprite Multiplexing with Sprite Banks.](../assets/integrating-vera/sprite_banking_muxing.drawio.png)
...
![512 Sprite Pixel Limit Examples.](../assets/integrating-vera/sprite_pixel_limit_examples.drawio.png)
...
![The VERA Wishbone Block Diagram.](../assets/integrating-vera/vera_wishbone.drawio.png)
...
![Frame Generated by vera_standalone Vmodel.](../assets/integrating-vera/vera_standalone_frame.png)
...
![Frame Generated by vera_integrated Vmodel.](../assets/integrating-vera/vera_integrated_frame.png)

*Frame generated by vera_integrated Verilator model.*

  The terminal window should look like this:

![vera_integrated terminal window.](../assets/integrating-vera/vera_integrated_terminal_window.png)
...
![Arty A7 Setup for vera_integrated Test SoC.](../assets/integrating-vera/vera_fpga_test_setup.jpg)
