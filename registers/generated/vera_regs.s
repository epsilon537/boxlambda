...
.equ VERA_DC_BORDERCOLOR_ADDR, 0x4

# DC_BORDERCOLOR.val - Border color
.equ VERA_DC_BORDERCOLOR_VAL_WIDTH, 8
.equ VERA_DC_BORDERCOLOR_VAL_LSB, 0
.equ VERA_DC_BORDERCOLOR_VAL_MASK, 0xff
# IEN - Interrupt enable register.
.equ VERA_IEN_ADDR, 0x8

# IEN.val - interrupt enable register.
.equ VERA_IEN_VAL_WIDTH, 3
.equ VERA_IEN_VAL_LSB, 0
.equ VERA_IEN_VAL_MASK, 0x7
# ISR - Interrupt status register.
.equ VERA_ISR_ADDR, 0xc

# ISR.ISR - interrupt status register
.equ VERA_ISR_ISR_WIDTH, 3
.equ VERA_ISR_ISR_LSB, 0
.equ VERA_ISR_ISR_MASK, 0x7
...
.equ VERA_IRQLINE_VAL_WIDTH, 10
.equ VERA_IRQLINE_VAL_LSB, 0
.equ VERA_IRQLINE_VAL_MASK, 0x3ff
# SCANLINE - Scanline register
.equ VERA_SCANLINE_ADDR, 0x14

# SCANLINE.val - Current scanline.
.equ VERA_SCANLINE_VAL_WIDTH, 10
.equ VERA_SCANLINE_VAL_LSB, 0
.equ VERA_SCANLINE_VAL_MASK, 0x3ff
...
.equ VERA_DC_HSCALE_VAL_WIDTH, 8
.equ VERA_DC_HSCALE_VAL_LSB, 0
.equ VERA_DC_HSCALE_VAL_MASK, 0xff
...
.equ VERA_DC_VSCALE_VAL_WIDTH, 8
.equ VERA_DC_VSCALE_VAL_LSB, 0
.equ VERA_DC_VSCALE_VAL_MASK, 0xff
...
.equ VERA_DC_HSTART_VAL_WIDTH, 10
.equ VERA_DC_HSTART_VAL_LSB, 0
.equ VERA_DC_HSTART_VAL_MASK, 0x3ff
...
.equ VERA_DC_HSTOP_VAL_WIDTH, 10
.equ VERA_DC_HSTOP_VAL_LSB, 0
.equ VERA_DC_HSTOP_VAL_MASK, 0x3ff
...
.equ VERA_DC_VSTART_VAL_WIDTH, 10
.equ VERA_DC_VSTART_VAL_LSB, 0
.equ VERA_DC_VSTART_VAL_MASK, 0x3ff
...
.equ VERA_DC_VSTOP_VAL_WIDTH, 10
.equ VERA_DC_VSTOP_VAL_LSB, 0
.equ VERA_DC_VSTOP_VAL_MASK, 0x3ff
...
.equ VERA_L0_CONFIG_COLORDEPTH_WIDTH, 2
.equ VERA_L0_CONFIG_COLORDEPTH_LSB, 0
.equ VERA_L0_CONFIG_COLORDEPTH_MASK, 0x3
# L0_CONFIG.BITMAPMODE - 1 selects bitmap mode, 0 selects tile mode.
.equ VERA_L0_CONFIG_BITMAPMODE_WIDTH, 1
.equ VERA_L0_CONFIG_BITMAPMODE_LSB, 2
.equ VERA_L0_CONFIG_BITMAPMODE_MASK, 0x4
...
.equ VERA_L0_MAPBASE_VAL_WIDTH, 8
.equ VERA_L0_MAPBASE_VAL_LSB, 0
.equ VERA_L0_MAPBASE_VAL_MASK, 0xff
...
.equ VERA_L0_TILEBASE_TILE_BASEADDR_WIDTH, 6
.equ VERA_L0_TILEBASE_TILE_BASEADDR_LSB, 2
.equ VERA_L0_TILEBASE_TILE_BASEADDR_MASK, 0xfc
...
.equ VERA_L0_HSCROLL_HSCROLL_11_8_PALOFFSET_WIDTH, 4
.equ VERA_L0_HSCROLL_HSCROLL_11_8_PALOFFSET_LSB, 8
.equ VERA_L0_HSCROLL_HSCROLL_11_8_PALOFFSET_MASK, 0xf00
...
.equ VERA_L0_VSCROLL_VAL_WIDTH, 12
.equ VERA_L0_VSCROLL_VAL_LSB, 0
.equ VERA_L0_VSCROLL_VAL_MASK, 0xfff
...
.equ VERA_L1_CONFIG_COLORDEPTH_WIDTH, 2
.equ VERA_L1_CONFIG_COLORDEPTH_LSB, 0
.equ VERA_L1_CONFIG_COLORDEPTH_MASK, 0x3
# L1_CONFIG.BITMAPMODE - 1 selects bitmap mode, 0 selects tile mode.
.equ VERA_L1_CONFIG_BITMAPMODE_WIDTH, 1
.equ VERA_L1_CONFIG_BITMAPMODE_LSB, 2
.equ VERA_L1_CONFIG_BITMAPMODE_MASK, 0x4
...
.equ VERA_L1_MAPBASE_VAL_WIDTH, 8
.equ VERA_L1_MAPBASE_VAL_LSB, 0
.equ VERA_L1_MAPBASE_VAL_MASK, 0xff
...
.equ VERA_L1_TILEBASE_TILE_BASEADDR_WIDTH, 6
.equ VERA_L1_TILEBASE_TILE_BASEADDR_LSB, 2
.equ VERA_L1_TILEBASE_TILE_BASEADDR_MASK, 0xfc
...
.equ VERA_L1_HSCROLL_HSCROLL_11_8_PALOFFSET_WIDTH, 4
.equ VERA_L1_HSCROLL_HSCROLL_11_8_PALOFFSET_LSB, 8
.equ VERA_L1_HSCROLL_HSCROLL_11_8_PALOFFSET_MASK, 0xf00
...
.equ VERA_L1_VSCROLL_VAL_WIDTH, 12
.equ VERA_L1_VSCROLL_VAL_LSB, 0
.equ VERA_L1_VSCROLL_VAL_MASK, 0xfff
