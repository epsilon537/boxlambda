...
- **Interconnect Component in the BoxLambda Directory Tree**:
  [gw/components/interconnect](https://github.com/epsilon537/boxlambda/tree/v0.4.1/gw/components/interconnect)

- **Instruction Bus Module**:
  [gw/components/interconnect/rtl/instruction_bus.sv](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/components/interconnect/rtl/instruction_bus.sv)

- **Data Bus Module**:
  [gw/components/interconnect/rtl/data_bus.sv](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/components/interconnect/rtl/data_bus.sv)
...
![BoxLambda Block Diagram](../../assets/Arch-Diagram-dual-bus-DFX.png)
...
[![The Data Bus and the Instruction Bus.](../../assets/data-bus-and-instruction-bus.png)](../../assets/data-bus-and-instruction-bus.png)
...
[![Arbiter without arbitration overhead on the default port.](../../assets/arbiter-wo-overhead.png)](../../assets/arbiter-wo-overhead.png)
...
![Byte vs. Word Addressing.](../../assets/byte-vs-word-addressing.png)
...
![Word Addressing a byte with byte enables.](../../assets/addressing-a-byte-w-byte-enables.png)
