...
- **Usb_hid_host Component in the BoxLambda Directory Tree**:
    [gw/components/usb_hid_host](https://github.com/epsilon537/boxlambda/tree/master/gw/components/usb_hid_host)
...
- **Usb_hid_device Component in the BoxLambda Directory Tree**:
    [gw/components/test/usb_hid_device](https://github.com/epsilon537/boxlambda/tree/master/gw/components/test/usb_hid_device)
...
![NAND2Mario usb_hid_host core.](../../assets/usb-hid-host-orig.png)
...
![SetReport Keyboard LED bitmap.](../../assets/keyboard-led-bitmap.jpg)
...
![Keyboard LED Control in usb_hid_host.](../../assets/keyboard-led-ctrl-in-usb-hid-host.png)
...
![usb_hid_host with Wishbone frontend.](../../assets/usb-hid-host-new.png)
