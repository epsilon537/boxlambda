...
- **VS0 Stub** Component in the BoxLambda Directory Tree:
  [gw/components/vs0_stub](https://github.com/epsilon537/boxlambda/tree/develop/gw/components/vs0_stub)

- **VS0 J1B** Component in the BoxLambda Directory Tree:
  [gw/components/test/vs0_j1b](https://github.com/epsilon537/boxlambda/tree/develop/gw/components/test/vs0_j1b)
...
![The vs0_stub](../../assets/vs0-stub.png)

*The vs0_stub.*

- `VS0_j1b` is a J1B Core fitted to the VS0 interface.

![The J1B Core fitted to the VS0 interface](../../assets/vs0-j1b.png)
...
See the [DFX Test Build](../test/builds/dfx.md) for an example.
