...
- **SPI Flash Gateware Component in the BoxLambda Directory Tree**:
    [gw/components/spiflash](https://github.com/epsilon537/boxlambda/tree/v0.4.1/gw/components/spiflash)

- **SPI Flash Core Top-Level**:
    [gw/components/spiflash/rtl/spiflash.v](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/components/spiflash/rtl/spiflash.v)
...
[../../../gw/components/spiflash/sim/flashsim.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/components/spiflash/sim/flashsim.cpp)
