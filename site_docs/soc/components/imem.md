...
- **DPRAM Component in the BoxLambda Directory Tree**:
    [gw/components/wb_dp_ram](https://github.com/epsilon537/boxlambda/tree/v0.4.1/gw/components/wb_dp_ram)

- **DPRAM Core Top-Level**:
    [gw/components/wb_dp_ram/rtl/wb_dp_ram_wrapper.sv](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/components/wb_dp_ram/rtl/wb_dp_ram_wrapper.sv)
...
The default IMEM memory image is generated by the [bootloader](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/projects/bootloader) software project. This project is built during the code generation stage. The resulting `.mem` file is used as the default IMEM memory initialization file.
