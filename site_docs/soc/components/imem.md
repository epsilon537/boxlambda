...
- **DPRAM Component in the BoxLambda Directory Tree**:
    [gw/components/wb_dp_ram](https://github.com/epsilon537/boxlambda/tree/develop/gw/components/wb_dp_ram)

- **DPRAM Core Top-Level**:
    [gw/components/wb_dp_ram/rtl/wb_dp_ram_wrapper.sv](https://github.com/epsilon537/boxlambda/blob/develop/gw/components/wb_dp_ram/rtl/wb_dp_ram_wrapper.sv)
...
The default IMEM memory image is generated by the [bootloader](https://github.com/epsilon537/boxlambda/tree/develop/sw/projects/bootloader) software project. This project is built during the code generation stage. The resulting `.mem` file is used as the default IMEM memory initialization file.

When building a `<gw_project>_bit` target, this default memory image will be replaced with the image of the software program referenced in the gateware project's `CMakeLists.txt` file (using [post-synthesis memory update](../build-sys/building.md#updatemem-and-xpm-memories)).
