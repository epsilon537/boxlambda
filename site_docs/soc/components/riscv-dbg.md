...
- **RISCV-DBG Gateware Component in the BoxLambda Directory Tree**:
  [gw/components/riscv-dbg](https://github.com/epsilon537/boxlambda/tree/v0.4.1/gw/components/riscv-dbg)
...
[gw/components/riscv-dbg/Bender.yml](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/components/riscv-dbg/Bender.yml).
...
The OpenOCD configuration file: [scripts/openocd.cfg](https://github.com/epsilon537/boxlambda/blob/v0.4.1/scripts/openocd.cfg) (see the *if..VERILATOR* section).
...
OpenOCD configuration file for debugging on the Arty-A7 is available in the `scripts/` directory: [scripts/openocd.cfg](https://github.com/epsilon537/boxlambda/blob/v0.4.1/scripts/openocd.cfg)
