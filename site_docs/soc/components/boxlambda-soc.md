...
- **BoxLambda SoC Component in the BoxLambda Directory Tree**:
    [gw/components/boxlambda_soc](https://github.com/epsilon537/boxlambda/tree/master/gw/components/boxlambda_soc)
...
- **BoxLambda Top Module**:
    [gw/projects/boxlambda_base/rtl/boxlambda_top.sv](https://github.com/epsilon537/boxlambda/blob/master/gw/projects/boxlambda_base/rtl/boxlambda_top.sv)
