...
[gw/projects/boxlambda-dfx](https://github.com/epsilon537/boxlambda/tree/v0.4.1/gw/projects/boxlambda_dfx)
...
Refer to the section on [DFX Controller Parameterization](../components/dfx-controller.md#dfx-controller-parameterization).
...
![Pblock with properties](../../assets/pblock-w-properties.png)
...
3. Draw a rectangular region while keeping track of the number of selected resources (e.g., LUTs, BRAM) to ensure enough resources are available for the largest RM.
   ...
   ![Pblock with resources](../../assets/pblock-w-resources.png)
...
[gw/projects/boxlambda_dfx/constrs/pblocks.xdc](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/projects/boxlambda_dfx/constrs/pblocks.xdc)
...
![pblock routing](../../assets/pblock-routing.png)
...
![static design changes in pblock](../../assets/static-design-changes-in-pblock.png)
