...
[gw/projects/test/hello_world/sim/sim_main.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/projects/test/hello_world/sim/sim_main.cpp)

Other, more elaborate system test benches include:

- [*gw/projects/test/vera_integrated/sim/sim_main.cpp*](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/projects/test/vera_integrated/sim/sim_main.cpp): This test bench captures the DUT's VGA output and renders it to an SDL frame buffer.
- [*gw/projects/test/sdspi_test/sim/sim_main.cpp*](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/projects/test/sdspi_test/sim/sim_main.cpp): This test bench includes ZipCPU's SDSPISIM co-simulator.
- [*gw/projects/test/ym2149_dac_test/sim/sim_main.cpp*](https://github.com/epsilon537/boxlambda/blob/v0.4.1/gw/projects/test/ym2149_dac_test/sim/sim_main.cpp): This test bench captures the Audio DAC bitstream and PSG's PCM output, saving it to two Python files for further analysis by a Python script.
