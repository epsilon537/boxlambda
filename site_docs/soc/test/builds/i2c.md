...
The I2C test code running on the RISCV processor: [sw/projects/test/rtcc_test/i2c_test.cpp](https://github.com/epsilon537/boxlambda/blob/master/sw/projects/test/i2c_test/i2c_test.cpp)

The Verilator test bench code: [gw/projects/test/i2c_test/sim/sim_main.cpp](https://github.com/epsilon537/boxlambda/blob/master/gw/projects/test/i2c_test/sim/sim_main.cpp)
