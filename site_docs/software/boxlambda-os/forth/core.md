...
- **Forth Core Software Component in the BoxLambda Directory Tree**:
 [sw/components/forth/](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/components/forth)

- **Forth Core Entry Point**: [sw/components/forth/mecrisp-quintus-boxlambda.s](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/forth/mecrisp-quintus-boxlambda.s)
...
From BoxLambda OS's [main.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/projects/boxlambda_os/main.cpp):
...
The [link map](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/projects/boxlambda_os/link.ld) defines the following Forth sections:
...
Understanding the purpose of the following variables, defined in [forth-core.s](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/forth/forth-core.s), is essential to be able to understand the Forth Core:
