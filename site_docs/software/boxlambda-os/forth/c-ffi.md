...
- [sw/components/forth/forth.h](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/forth.h):

Implementation:

- [sw/components/forth/forth.cpp](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/forth.cpp)
- The `c-fun` Word in [fs/forth/init.fs](https://github.com/epsilon537/boxlambda/blob/master/fs/forth/init.fs)
- Forth to C: [sw/components/forth/c-ffi.s](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/c-ffi.s)
- C to Forth: [sw/components/forth/mecrisp-quintus-boxlambda.s](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/mecrisp-quintus-boxlambda.s)
...
The Data Stack does require a software construct. The `forth_core_init()` function initializes a global `datastack` object with the following layout in C (see [forth.h](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/forth.h)):
...
C functions are registered with Forth using the following macro from [forth.h](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/forth.h):
...
See `forth_core_init_` and `forth_core_fun_` in [mecrisp-quintus-boxlambda.s](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/mecrisp-quintus-boxlambda.s).
...
See `call-c` in [c-ffi.s](https://github.com/epsilon537/boxlambda/blob/master/sw/components/forth/c-ffi.s) along with Word `c-fun` in [early.fs](https://github.com/epsilon537/boxlambda/blob/master/fs/forth/early.fs).
