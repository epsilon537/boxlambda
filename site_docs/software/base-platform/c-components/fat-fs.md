...
- **FatFs Software Component in the BoxLambda Directory Tree**:
  [sw/components/fatfs](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/components/fatfs)
...
- The *Storage Device Control Dispatcher*, [diskio.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/fatfs/diskio.cpp), dispatches FAT FS requests to RAM Disk Device Control or SD Card Device controls, depending on selected volume.
...
[diskio_ram.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/fatfs/diskio_ram.cpp)
...
The BoxKern configures external memory region `0x2ff00000-0x30000000` (1MB) for RAM disk usage. See the [link map](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/projects/boxlambda_os/link.ld).

## The SD Card Device Controller

Volume name: `sd0:`:

[diskio_sd.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/fatfs/diskio_sd.cpp)
