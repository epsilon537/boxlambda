...
- **RTCC Software Component in the BoxLambda Directory Tree**:
  [sw/components/rtcc](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/components/rtcc)

- **Included in OS**: No

The Real-Time Clock and Calendar (RTCC) software component is based on the [MCP79412RTC](https://github.com/epsilon537/MCP79412RTC) library. The library interfaces with Digilent's [PMOD RTCC](../../../installation/pmods.md#rtcc-pmod) via I2C.
...
- [sw/projects/test/rtcc_test/rtcc_test.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/projects/test/rtcc_test/rtcc_test.cpp)
- [sw/projects/test/rtcc_test/rtcc_cli.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/projects/test/rtcc_test/rtcc_cli.cpp)
