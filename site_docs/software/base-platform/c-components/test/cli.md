...
- **Embedded CLI Software Component in the BoxLambda Directory Tree**:
  [sw/components/test/embedded_cli](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/components/test/embedded_cli)
...
[sw/components/test/embedded_cli/embedded_cli_setup.h](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/test/embedded_cli/embedded_cli_setup.h)
