...
The **VS0 HAL API** provides common definitions for all VS0 RM variants, currently including `vs0_j1b` and `vs0_stub`. You can find the API here: [sw/components/vs0_hal/vs0_hal.h](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/vs0_hal/vs0_hal.h).
