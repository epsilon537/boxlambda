...
- **SDSPI Software Component in the BoxLambda Directory Tree**:
  [sw/components/sdspi/](https://github.com/epsilon537/boxlambda/tree/develop/sw/components/sdspi)

- **Included in OS**: Yes

The SDSPI software component provides the following APIs:

- [sdspi_hal.h](https://github.com/epsilon537/boxlambda/blob/develop/sw/components/sdspi/sdspi_hal.h): This is just the SDSPI Register Access Layer with some additional helper definitions.
