...
![VERA Pixels, Tiles, Tilesets, Maps.](../../../assets/vera-pixels-tiles-tilesets-maps.png)
...
**VERA HAL**: [sw/components/vera/vera_hal.h](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/vera/vera_hal.h)

The VERA Hardware Abstraction Layer is a C++ class hierarchy:

![VERA Hardware Abstraction Layer.](../../../assets/vera-hal.png)
