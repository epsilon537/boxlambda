...
- **SDRAM Software Component in the BoxLambda Directory Tree**: [sw/components/sdram](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/components/sdram)
...
![sdram_init()](../../../assets/sdram-init.drawio.png)
...
[../../../sw/projects/test/ddr_test/ddr_test.cpp](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/projects/test/ddr_test/ddr_test.cpp)
