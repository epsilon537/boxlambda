...
- **I2C Software Component in the BoxLambda Directory Tree**:
  [sw/components/i2c](https://github.com/epsilon537/boxlambda/tree/v0.4.1/sw/components/i2c)
- **I2C API**:
  [sw/components/i2c/i2c.h](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/i2c/i2c.h)
