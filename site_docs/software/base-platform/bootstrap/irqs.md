...
- On the BoxLambda OS build, the Forth Core will take ownership of all the IRQ vectors. See [interrupts.s](https://github.com/epsilon537/boxlambda/blob/v0.4.1/sw/components/forth/interrupts.s).
