...
int sdspi_test(void) {
	...
	v = _sdcard->sd_data;
	printf("    OCR = 0x%08x. %s\n", v, (v!=0xc0ff8000) ? "Shouldnt this be 0xc0ff8000?" : "");
	//0xc0ff8000: Card can handle between 2.7 and 3.6 Volts, it is a higher capacity card, and 
	//it has completed its startup sequence.
