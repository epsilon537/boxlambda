...
(defun vera_example ()
  ...
  (vera :vscale scale)
  (vera :sprites :enable)
  (vera :tileset 0 :width tile_sz :height tile_sz :bpp bpp :num-tiles 1)
  (vera :tileset 1 :width sprite_sz :height sprite_sz :bpp bpp :num-tiles 1)
  (vera :map 0 :width map_sz :height map_sz :map-type +vera-map-type-tile+)
  (vera :layer 0 :enable)
  (vera :layer 0 :map 0)
  ...
  (dotimes (ii tile_sz)
    ...
    (vera :pixel :tileset 0 :tile 0 :x ii :y (1- tile_sz) :val +vera-color-yellow+)
    (vera :pixel :tileset 0 :tile 0 :x (1- tile_sz) :y ii :val +vera-color-yellow+))
