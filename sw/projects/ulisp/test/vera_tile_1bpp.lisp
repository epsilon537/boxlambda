...
(vera :display :enable)
(vera :layer 0 :enable)
(vera :map 0 :width 32 :height 32 :map_type VERA_MAP_TYPE_TXT16)
(vera :layer 0 :map 0)
(vera :map 0 :entry :x 0 :y 0 :val 257)
(dolist (w (list 8 16))
  (dolist (h (list 8 16))
    (vera :tileset 0 :width w :height h :bpp 1 :num_tiles 8)
    (vera :layer 0 :tileset 0)
    (vera :pixel :tileset 0 :tile 1 :x (- w 1) :y (- h 1) :val 1)
