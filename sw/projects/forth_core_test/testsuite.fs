...
ALIGN 1 ALLOT HERE HALIGN HERE ALIGN HERE 3 CELLS ALLOT
CONSTANT A-ADDR CONSTANT HA-ADDR CONSTANT UA-ADDR
T{ UA-ADDR HALIGNED -> HA-ADDR }T
T{ UA-ADDR ALIGNED -> A-ADDR }T
T{ HA-ADDR ALIGNED -> A-ADDR }T
...
align here 0 c, halign here 0 c, halign here
constant 3rdha
constant 2ndha
constant 1stha
T{ 1stha 2+ -> 2ndha }T
...
CREATE FBUF $00000000 , \ 00 C, 00 C, 00 C,
CREATE SBUF $00563412 , \ 12 C, 34 C, 56 C,
...
T{ ramvar-here 256 1024 * < -> <TRUE> }T
T{ compiletoimem compiletoemem? -> <FALSE> }T
T{ here ramvar-here < -> <TRUE> }T
: imemword 1479 ;
compiletoemem
T{ here $20000000 > -> <TRUE> }T
T{ here 1024 1024 * 256 * $20000000 + < -> <TRUE> }T
