...
: mapentry-txt256
  ...
  tm tmap{ #32 width #32 height TMAP-TXT256 type }set
  tm tmap-print
...
[: mapentry-txt256 ;] &>file tst_dir/vera-mapentry-txt256.log

s" tst_dir/vera-mapentry-txt256.log" s" vera-mapentry-txt256.ref" f_cmp ?assert
