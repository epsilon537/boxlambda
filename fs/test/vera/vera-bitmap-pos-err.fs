...
: bitmap-pos-err-test
  ...
  pxl{ ts tset 0 tidx 320 0 vec2 xy #101 color }set
  pxl{ ts tset 0 tidx 0 64 vec2 xy #101 color }set

  ts tset{ 640 width 32 height 1 bpp 1 tiles }set
  pxl{ ts tset 0 tidx 640 0 vec2 xy #101 color }set
  pxl{ ts tset 0 tidx 0 32 vec2 xy #101 color }set
;
