...
: (pixel-set-4bpp) ( pxlval point base width -- )
  rot dup x> (4bpp-bitoffset-of-x) >r ( pxlval base y width point R: bitoffset )
  (4bpp-pixel-byte-ptr) ( pxlval ptr R: bitoffset )
  dup c@ ( oldbyte R: bitoffset )
  $f r@ lshift bic ( pxlval ptr oldbytemasked R: bitoffset )
...
: (pixel-set-8bpp) ( pxlval point base width -- )
  rot dup x> (4bpp-bitoffset-of-x) >r ( pxlval base y width point R: bitoffset )
  (4bpp-pixel-byte-ptr) ( pxlval ptr R: bitoffset )
  dup c@ ( oldbyte R: bitoffset )
  $f r@ lshift bic ( pxlval ptr oldbytemasked R: bitoffset )
...
\ --- Pixel Get Functions ---
: (pixel-get-1bpp) ( point base width -- pxlval )
  rot dup x> (4bpp-bitoffset-of-x) >r ( base width point R: bitoffset )
  (4bpp-pixel-byte-ptr) ( ptr R: bitoffset )
  c@ r> rshift $f and ( pxlval )

: (pixel-get-2bpp) ( point base width -- pxlval )
  rot dup x> (4bpp-bitoffset-of-x) >r ( base width point R: bitoffset )
  (4bpp-pixel-byte-ptr) ( ptr R: bitoffset )
  c@ r> rshift $f and ( pxlval )

: (pixel-get-4bpp) ( point base width -- pxlval )
  rot dup x> (4bpp-bitoffset-of-x) >r ( base width point R: bitoffset )
  (4bpp-pixel-byte-ptr) ( ptr R: bitoffset )
  c@ r> rshift $f and ( pxlval )

: (pixel-get-8bpp) ( point base width -- pxlval )
  rot dup x> (4bpp-bitoffset-of-x) >r ( base width point R: bitoffset )
  (4bpp-pixel-byte-ptr) ( ptr R: bitoffset )
  c@ r> rshift $f and ( pxlval )
