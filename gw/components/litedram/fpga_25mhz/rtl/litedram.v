...
reg     [4:0] main_a7ddrphy_half_sys8x_taps_storage = 5'd32;
...
reg           main_bankmachine0_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine0_trascon_ready = 1'd0;
wire          main_bankmachine0_trascon_valid;
reg           main_bankmachine0_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine1_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine1_trascon_ready = 1'd0;
wire          main_bankmachine1_trascon_valid;
reg           main_bankmachine1_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine2_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine2_trascon_ready = 1'd0;
wire          main_bankmachine2_trascon_valid;
reg           main_bankmachine2_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine3_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine3_trascon_ready = 1'd0;
wire          main_bankmachine3_trascon_valid;
reg           main_bankmachine3_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine4_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine4_trascon_ready = 1'd0;
wire          main_bankmachine4_trascon_valid;
reg           main_bankmachine4_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine5_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine5_trascon_ready = 1'd0;
wire          main_bankmachine5_trascon_valid;
reg           main_bankmachine5_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine6_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine6_trascon_ready = 1'd0;
wire          main_bankmachine6_trascon_valid;
reg           main_bankmachine6_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
reg           main_bankmachine7_trascon_count = 1'd0;
(* dont_touch = "true" *)
reg           main_bankmachine7_trascon_ready = 1'd0;
wire          main_bankmachine7_trascon_valid;
reg           main_bankmachine7_trccon_count = 1'd0;
(* dont_touch = "true" *)
...
wire          main_tfawcon_count;
(* dont_touch = "true" *)
reg           main_tfawcon_ready = 1'd1;
wire          main_tfawcon_valid;
reg     [1:0] main_tfawcon_window = 2'd0;
reg     [4:0] main_time0 = 5'd0;
reg     [3:0] main_time1 = 4'd0;
wire    [7:0] main_timer_count0;
reg     [7:0] main_timer_count1 = 8'd195;
...
reg     [1:0] main_twtrcon_count = 2'd0;
(* dont_touch = "true" *)
...
wire   [24:0] main_zqcs_timer_count0;
reg    [24:0] main_zqcs_timer_count1 = 25'd24999999;
...
assign main_tfawcon_count = (main_tfawcon_window[0] + main_tfawcon_window[1]);
always @(*) begin
...
always @(posedge sys_clk) begin
    ...
    if ((main_zqcs_timer_wait & (~main_zqcs_timer_done0))) begin
        ...
        main_zqcs_timer_count1 <= 25'd24999999;
    end
    ...
    if (main_bankmachine0_trccon_valid) begin
        main_bankmachine0_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine0_trascon_valid) begin
        main_bankmachine0_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine1_trccon_valid) begin
        main_bankmachine1_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine1_trascon_valid) begin
        main_bankmachine1_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine2_trccon_valid) begin
        main_bankmachine2_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine2_trascon_valid) begin
        main_bankmachine2_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine3_trccon_valid) begin
        main_bankmachine3_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine3_trascon_valid) begin
        main_bankmachine3_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine4_trccon_valid) begin
        main_bankmachine4_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine4_trascon_valid) begin
        main_bankmachine4_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine5_trccon_valid) begin
        main_bankmachine5_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine5_trascon_valid) begin
        main_bankmachine5_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine6_trccon_valid) begin
        main_bankmachine6_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine6_trascon_valid) begin
        main_bankmachine6_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine7_trccon_valid) begin
        main_bankmachine7_trccon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (main_bankmachine7_trascon_valid) begin
        main_bankmachine7_trascon_count <= 1'd1;
        if (1'd0) begin
    ...
    if (sys_rst) begin
        ...
        main_a7ddrphy_half_sys8x_taps_storage <= 5'd32;
        ...
        main_bankmachine0_trccon_ready <= 1'd0;
        main_bankmachine0_trccon_count <= 1'd0;
        main_bankmachine0_trascon_ready <= 1'd0;
        main_bankmachine0_trascon_count <= 1'd0;
        ...
        main_bankmachine1_trccon_ready <= 1'd0;
        main_bankmachine1_trccon_count <= 1'd0;
        main_bankmachine1_trascon_ready <= 1'd0;
        main_bankmachine1_trascon_count <= 1'd0;
        ...
        main_bankmachine2_trccon_ready <= 1'd0;
        main_bankmachine2_trccon_count <= 1'd0;
        main_bankmachine2_trascon_ready <= 1'd0;
        main_bankmachine2_trascon_count <= 1'd0;
        ...
        main_bankmachine3_trccon_ready <= 1'd0;
        main_bankmachine3_trccon_count <= 1'd0;
        main_bankmachine3_trascon_ready <= 1'd0;
        main_bankmachine3_trascon_count <= 1'd0;
        ...
        main_bankmachine4_trccon_ready <= 1'd0;
        main_bankmachine4_trccon_count <= 1'd0;
        main_bankmachine4_trascon_ready <= 1'd0;
        main_bankmachine4_trascon_count <= 1'd0;
        ...
        main_bankmachine5_trccon_ready <= 1'd0;
        main_bankmachine5_trccon_count <= 1'd0;
        main_bankmachine5_trascon_ready <= 1'd0;
        main_bankmachine5_trascon_count <= 1'd0;
        ...
        main_bankmachine6_trccon_ready <= 1'd0;
        main_bankmachine6_trccon_count <= 1'd0;
        main_bankmachine6_trascon_ready <= 1'd0;
        main_bankmachine6_trascon_count <= 1'd0;
        ...
        main_bankmachine7_trccon_ready <= 1'd0;
        main_bankmachine7_trccon_count <= 1'd0;
        main_bankmachine7_trascon_ready <= 1'd0;
        main_bankmachine7_trascon_count <= 1'd0;
        main_choose_cmd_grant <= 3'd0;
        main_choose_req_grant <= 3'd0;
        main_trrdcon_ready <= 1'd0;
        main_trrdcon_count <= 1'd0;
        main_tfawcon_ready <= 1'd1;
        main_tfawcon_window <= 2'd0;
        main_tccdcon_ready <= 1'd0;
        main_tccdcon_count <= 1'd0;
        main_twtrcon_ready <= 1'd0;
        main_twtrcon_count <= 2'd0;
        main_time0 <= 5'd0;
        main_time1 <= 4'd0;
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2025-01-31 21:47:24.
//------------------------------------------------------------------------------
