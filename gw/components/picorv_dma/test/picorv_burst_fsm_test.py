    ...
    while True:
        ...
        if dut.wbm_stb_o.value == 1:
            ...
            if dut.wbm_we_o.value == 1:
                ...
                wb_transactions.append(('write', int(dut.wbm_adr_o.value), int(dut.wbm_dat_o.value), int(dut.wbm_sel_o.value)))
            else:
                ...
                wb_transactions.append(('read', int(dut.wbm_adr_o.value), dat_r, int(dut.wbm_sel_o.value)))
...
async def picorv_read_burst_test_w_stalls_and_delays_offset_1(dut):
    ...
    for w in range(numBursts):
        ...
        read_words.append((burst_reg_0.integer>>8) | ((burst_reg_1.integer&0xff)<<24))
        read_words.append((burst_reg_1.integer>>8) | ((burst_reg_2.integer&0xff)<<24))
        read_words.append((burst_reg_2.integer>>8) | ((burst_reg_3.integer&0xff)<<24))
        read_words.append((burst_reg_3.integer>>8) | ((burst_reg_4.integer&0xff)<<24))
...
async def picorv_read_burst_test_w_stalls_and_delays_offset_2(dut):
    ...
    for w in range(numBursts):
        ...
        read_words.append((burst_reg_0.integer>>16) | ((burst_reg_1.integer&0xffff)<<16))
        read_words.append((burst_reg_1.integer>>16) | ((burst_reg_2.integer&0xffff)<<16))
        read_words.append((burst_reg_2.integer>>16) | ((burst_reg_3.integer&0xffff)<<16))
        read_words.append((burst_reg_3.integer>>16) | ((burst_reg_4.integer&0xffff)<<16))
...
async def picorv_read_burst_test_w_stalls_and_delays_offset_3(dut):
    ...
    for w in range(numBursts):
        ...
        read_words.append((burst_reg_0.integer>>24) | ((burst_reg_1.integer&0xffffff)<<8))
        read_words.append((burst_reg_1.integer>>24) | ((burst_reg_2.integer&0xffffff)<<8))
        read_words.append((burst_reg_2.integer>>24) | ((burst_reg_3.integer&0xffffff)<<8))
        read_words.append((burst_reg_3.integer>>24) | ((burst_reg_4.integer&0xffffff)<<8))
...
async def picorv_burst_reg_write_read_back(dut):
    ...
    for ii in range(5):
        ...
        dut._log.info("read from burst reg %d: 0x%x", ii, data.integer)
