...
//i2c slave co-simulation from wbi2c.
std::unique_ptr<I2CSIMSLAVE> i2c_slave{new I2CSIMSLAVE(I2C_SLAVE_ADDR)};
I2CBUS i2cbus;
...
static void tick(void) {
  ...
  //Fee our model's scl and sda signals to the I2C slave co-simulator.
  i2cbus = (*i2c_slave)(top->i2c_scl_o, top->i2c_sda_o);
  top->i2c_scl_i = i2cbus.m_scl;
  top->i2c_sda_i = i2cbus.m_sda;
