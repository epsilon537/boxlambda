...
./Vmodel -s $SRC_ROOT_DIR/gw/projects/test/stsound_test/test/sdcard.img
...
REF_WAV="$SRC_ROOT_DIR/gw/projects/test/stsound_test/test/ref.wav"
...
$SRC_ROOT_DIR/gw/projects/test/stsound_test/test/stsound_test.py -r $REF_WAV
